...
#include "objectivecsourcewizard.h"
 ...
 * @param parent
 */
ObjectiveCSourceWizard::ObjectiveCSourceWizard()
{
    ...
    setDisplayName(ObjectiveCSourceWizard::tr(Constants::EN_OBJC_SOURCE_DISPLAY_NAME));
    setDescription(ObjectiveCSourceWizard::tr(Constants::EN_OBJC_SOURCE_DESCRIPTION));
}
 ...
 * @return
 */
QWizard *ObjectiveCSourceWizard::createWizardDialog(QWidget *parent,
...
Core::GeneratedFiles ObjectiveCSourceWizard::generateFiles(const QWizard *dialog,
