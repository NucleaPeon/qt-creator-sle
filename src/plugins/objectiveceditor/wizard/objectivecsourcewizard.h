...
#ifndef OBJECTIVECSOURCEWIZARD_H
#define OBJECTIVECSOURCEWIZARD_H

#include <coreplugin/basefilewizard.h>

namespace ObjectiveCEditor {

class ObjectiveCSourceWizard : public Core::BaseFileWizard
{
    Q_OBJECT

public:
    ObjectiveCSourceWizard();
...
#endif // OBJECTIVECSOURCEWIZARD_H
