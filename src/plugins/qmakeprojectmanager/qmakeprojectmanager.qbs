...
QtcPlugin {
    ...
    Group {
        ...
        files: [
            ...
            "osxappwizard.cpp", "osxappwizard.h",
            "osxfullappwizard.cpp", "osxfullappwizard.h",
            "osxappwizarddialog.cpp", "osxappwizarddialog.h",	
            "osxfullappwizarddialog.cpp", "osxfullappwizarddialog.h",	
